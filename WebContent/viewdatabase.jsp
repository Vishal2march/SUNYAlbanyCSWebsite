...
Status = PHD<%=session.getAttribute("program") %><br>
...
String query="select * from degreecourses where degreename='"+programp+"'";
...
%>
    ...
    <td><%=rs.getString("recommendations") %></td>
    <td><%=rs.getString("Tests") %></td>
    <td><%=rs.getString("corecourses") %></td>
    <td><%=rs.getString("proficiencyexam") %></td>
